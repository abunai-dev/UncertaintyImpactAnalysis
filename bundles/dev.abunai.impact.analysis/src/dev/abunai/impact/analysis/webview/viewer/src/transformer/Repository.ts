...
import { FlatMapTransformer, getOfType, ID, JsonBase } from "./base";
...
import { buildSignatureNode } from "../diagramElements/nodes/SignatureNode";
import { buildBasicComponent } from "../diagramElements/nodes/BasicComponent";
